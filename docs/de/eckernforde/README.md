...
Perhaps the content is inaccurate, so please [let us know](https://github.com/ow2-quick-app-initiative/poi-quick-app-implementations/issues/new?labels=de/eckernforde) if you've spotted anything that might be enhanced. 
...
- *database* ([`./data.json`](https://github.com/ow2-quick-app-initiative/poi-quick-app-implementations/blob/main/docs/de/eckernforde/data.json)): JSON file with the app's configuration (name, colors, privacy texts, etc.) and the points of interest you want to show in the app. 

You can download it to your computer, modify the texts, or add a new element based on your knowledge. You can upload it directly (better a Pull Request if you are familiar with GitHub) or [raise an issue](https://github.com/ow2-quick-app-initiative/poi-quick-app-implementations/issues/new?labels=de/eckernforde) to suggest the changes (please be explicit).
...
The images are in the [`./images` directory](https://github.com/ow2-quick-app-initiative/poi-quick-app-implementations/blob/main/docs/de/eckernforde/images/). 
...
The database is in a JSON file named [`data.json`](https://github.com/ow2-quick-app-initiative/poi-quick-app-implementations/blob/main/docs/de/eckernforde/data.json) in the project's root directory.. 
...
``` json
{
    "issue_url": "https://github.com/ow2-quick-app-initiative/poi-quick-app-implementations/issues/new?labels=de/eckernforde&template=update_request.md&title=Update+request+of+"
}
```
...
Feel free to [raise issues](https://github.com/ow2-quick-app-initiative/poi-quick-app-implementations/issues/new?labels=de/eckernforde) on the code.
